					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "CRUD",
									"targetURL": "#crudoperations-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"crudoperations-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=crudoperations",
									"url": sap.ui.require.toUrl("crudoperations")
								}
							}
						}
					}
